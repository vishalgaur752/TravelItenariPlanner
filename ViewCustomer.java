...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username) {
        ...
        lblphone.setBounds(500, 110, 110, 25);
        add(lblphone);
        ...
        Image i2 = i1.getImage().getScaledInstance(600, 200, Image_SCALE_DEFAULT);
        ...
        Image i5 = i4.getImage().getScaledInstance(600, 200, Image_SCALE_DEFAULT);
